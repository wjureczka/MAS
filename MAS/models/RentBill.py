...
class RentBill(db.Model):
    ...
    rental_agreement = db.relationship("RentalAgreement", back_populates='bills')
    rental_agreement_id = db.Column(db.Integer, db.ForeignKey('rental_agreement.id'), primary_key=True, nullable=False)
